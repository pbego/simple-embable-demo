...
**Chat history and memory:** see [TUTORIAL-MEMORY-SUMMARIZATION.md](TUTORIAL-MEMORY-SUMMARIZATION.md) for persistent conversations (`chat`, `conversations`, `resume-chat`).
...
├── pom.xml
├── TUTORIAL.md
├── TUTORIAL-MEMORY-SUMMARIZATION.md
...
| `simple-demo.memory-max-messages` | `20` | Recent messages in LLM context (see [TUTORIAL-MEMORY-SUMMARIZATION.md](TUTORIAL-MEMORY-SUMMARIZATION.md)) |
